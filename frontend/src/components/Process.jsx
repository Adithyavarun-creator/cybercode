    ...
    <section id="about" className="mt-10 px-12 flex flex-col gap-6">
      ...
      <div className="mt-10 md:mt-4 grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-10">
        ...
        <div className="flex cursor-pointer gap-8 text-white px-6 py-4 rounded-2xl">
          ...
          <div className="flex flex-col gap-2">
            <span className="text-3xl font-semibold">Customized Strategy</span>
            <article className="text-gray-500">
        ...
        <div className="flex cursor-pointer gap-8 text-white px-6 py-4 rounded-2xl">
          ...
          <div className="flex flex-col gap-2">
            <span className="text-3xl font-semibold">Implementation</span>
            <article className="text-gray-500">
        ...
        <div className="flex cursor-pointer gap-8 text-white px-6 py-4 rounded-2xl">
          ...
          <div className="flex flex-col gap-2">
            <span className="text-3xl font-semibold">Regular Updates</span>
            <article className="text-gray-500">
        ...
        <div className="flex cursor-pointer gap-8 text-white px-6 py-4 rounded-2xl">
          ...
          <div className="flex flex-col gap-2">
            <span className="text-3xl font-semibold">Expert Support</span>
            <article className="text-gray-500">
