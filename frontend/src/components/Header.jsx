...
const Header = () => {
  return (
    <header className="mt-16 flex flex-col relative">
      <div>
        <img
          src={HeaderImage}
          className="w-full h-[550px] opacity-40"
          alt="header"
        />
      </div>
      <div className="absolute top-30 px-10 flex flex-col gap-6">
        ...
        <div>
          <article className="text-gray-600 w-[600px]">
      ...
      <div className="mt-8 flex justify-between gap-10 px-10">
        <div className="flex flex-col gap-2">
          <span className="text-primary font-semibold text-3xl">500+</span>
          <span className="capitalize text-xl text-gray-800">
            Clients Protected
          </span>
        </div>

        <div className="flex flex-col gap-2">
          <span className="text-primary font-semibold text-3xl">24/7</span>
          <span className="capitalize text-xl text-gray-800">
            Threat Monitoring
          </span>
        </div>
        ...
        <div className="flex flex-col gap-2">
          <span className="text-primary font-semibold text-3xl">99.9%</span>
          <span className="capitalize text-xl text-gray-800">Uptime SLA</span>
        </div>
      </div>
      ...
      <div className="mt-6">
        <img
          ...
          alt=""
          className="w-full h-[500px] opacity-60"
        />
      </div>
    </header>
  );
