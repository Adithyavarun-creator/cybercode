...
const Footer = () => {
  return (
    <footer id="contact" className="flex flex-col gap-10 px-14 mb-10">
      <div className="grid grid-cols-4 justify-between gap-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <span className="text-gray-600">Threat Monitoring </span>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            <span className="text-gray-600">hello@cybershield.com</span>
            <span className="text-gray-600">+1 (234) 567-890 24/7</span>
            <span className="text-gray-600"> Security Hotline</span>
          </div>
        </div>
      </div>
